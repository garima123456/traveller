...
def index(request):
    ...
    response = render(request,'beaches/index.html', context_dict)
...
"""def index(request):
    ...
    context_dict['visits'] = visits # check the problem with the code
    reset_last_visit_time = False
    response = render(request, 'beaches/index.html', context_dict)
...
def restricted(request):
    return render(request, 'beaches/restricted.html', {})
@login_required
